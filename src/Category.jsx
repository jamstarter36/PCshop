export const Category=()=>{
    return(
        ...
        <div className="flex flex-row justify-center items-center">
            <div className="grid grid-cols-2 md:grid-cols-4 w-300 m:w-120 h-full bg-gray-200 gap-2 p-2">
                <div className="bg-white rounded-xl shadow-sm flex justify-center items-center p-1 transition-transform duration-300 ease-in-out hover:scale-110">
